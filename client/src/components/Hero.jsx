    ...
    justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
      <div className='text-center mb-6'>
        ...
        font-semibold mx-auto leading-[1.2]'>
          Want to create some amazing content <br /> with <span className='text-primary'>AI tools</span>
        </h1>
        <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto
        max-sm:text-xs text-gray-600'>
          You can easily transform your content with our premium AI tools 
          where You can write articles, generate Images and enhance your workflow.
        </p>
      </div>
