...
const BlogTitles = () => {
  ...
  const blogCat =['General','Technology','Business','Health'
    ...
    text-slate-700'>
      ...
      border-gray-200'>
        ...
        <div className='mt-3 flex gap-3 flex-wrap sm:max-w-9/11'>
          {blogCat.map((item)=>(
            <span onClick={()=>setSelectedCat(item)} className={`text-xs px-4 py-1 border rounded-full
            cursor-pointer ${selectedCat === item ? 'bg-purple-50 text-purple-700':
