  ...
  return (
    ...
    text-slate-700'>
      ...
      border-gray-200'>
        ...
        rounded-md border border-gray-300' placeholder='e.g., watch or spoon, only single objuect name' required/>
      ...
      border-gray-200 min-h-96 '>
        ...
        <div className='flex-1 flex justify-center items-center'> 
          ...
          text-gray-400'>
            ...
            <p>Enter the Image and click "Remove Object" to get started</p>
          </div>
        </div>
      </div>
    </div>
